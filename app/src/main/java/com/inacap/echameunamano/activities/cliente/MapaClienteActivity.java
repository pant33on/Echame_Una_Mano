...
public class MapaClienteActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void solicitarOperador() {
        if(origenLatLng != null && destinoLatLng != null){
                ...
                Intent intent = new Intent(MapaClienteActivity.this, DetalleSolicitudActivity.class);
    ...
    private void onCameraMove(){
        camaraListener = new GoogleMap.OnCameraIdleListener() {
            ...
            public void onCameraIdle() {
                try {
                    Geocoder geocoder = new Geocoder(MapaClienteActivity.this);
    ...
    private void setPuntoOrigen() {
        ...
        autoCompletar.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onError(@NonNull Status status) {
                Toast.makeText(MapaClienteActivity.this, "Algo ocurrió", Toast.LENGTH_SHORT).show();
