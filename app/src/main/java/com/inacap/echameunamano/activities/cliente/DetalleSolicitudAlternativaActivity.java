...
public class DetalleSolicitudAlternativaActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_solicitud_alternativa);
        ...
        googleApiProvider = new GoogleApiProvider(DetalleSolicitudAlternativaActivity.this);
    ...
    private void irASolicitudOperador() {
        Intent intent = new Intent(DetalleSolicitudAlternativaActivity.this, SolicitudOperadorActivity.class);
        ...
        ajusteValorProvider.getAjusteValor().addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    String tipo = "";
                    if(tipoServicio.equals("servicio_bateria")){
